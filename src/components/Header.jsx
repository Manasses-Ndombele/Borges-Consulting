    ...
    return (
        <header>
            ...
            <menu className={`${mainMenuStatus} main-menu position-absolute start-0 top-0 vw-100 vh-100 m-0 p-0 text-end pe-3 pt-3 d-flex flex-column justify-content-center align-items-end`}>
                ...
                <nav className="main-nav d-flex flex-column align-items-center justify-content-center gap-2 w-100 px-5">
                    <a href="/" data-target-id="home-area" className={`${activeArea === 'home-area' ? 'active' : ''} p-2 text-uppercase text-decoration-none w-100 text-center`.trimStart()} onClick={toggleActiveArea}>Início</a>
                    <a data-target-id="company-area" className={`${activeArea === 'company-area' ? 'active' : ''} p-2 text-uppercase text-decoration-none w-100 text-center`.trimStart()} onClick={toggleActiveArea}>A empresa</a>
                    <a
