...
export default function Home() {
    return (
        <div id="home-area" className="group-main-area area">
            ...
            <div className="main-area d-flex flex-column align-items-center p-3 mx-md-auto justify-content-md-center">
                ...
                <a href="#services-area" className="w-100 text-md-center"><Button type="button" text="Saiba mais" min={false} /></a>
            </div>
        </div>
    )
}
